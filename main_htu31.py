...
db_user = 'shipper'
db_password = 'cmuhgcdb8403'
db_database = 'hgcdb'
log_location = 'dry_air_cabinet_4'
    
i2c = I2C(1, sda=Pin(21), scl=Pin(22))  # Correct I2C pins for ESP32
...
def log_to_DB(ssid, password, db_host, db_user, db_password, db_database):
    ...
    rel_hum = str(round(relative_humidity,2))
    temp_c = str(round(temperature,2))
